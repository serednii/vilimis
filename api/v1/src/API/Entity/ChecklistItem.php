...
class ChecklistItem
{
     ...
     * @ORM\Column checklist_group_id
     */
    private $checklist_group_id = null;
     ...
     * @return ?int
     */
    public function getChecklistGroupId(): ?int
    {
        return $this->checklist_group_id;
    }

    /**
     * @param ?int $checklist_group_id
     */
    public function setChecklistGroupId(?int $checklist_group_id)
    {
