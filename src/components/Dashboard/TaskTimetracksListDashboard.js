            ...
            <div className="card-body">
                <div className="list-group list-group-flush list-group-timeline">
                    {taskTimetracks && taskTimetracks.length > 0 && taskTimetracks.map((taskTimetrack, taskTimetrack_index) => (
                        ...
                        <div key={taskTimetrack_index} className="list-group-item border-0">
                            <div role="presentation" className="row ps-lg-1" style={{cursor:"pointer"}}>
                            ...
                            <div>
                                {(new Date(taskTimetrack.datetimeStart.date.substring(0, 16))).toLocaleDateString()}
                                <br/>
                                {(new Date(taskTimetrack.datetimeStart.date.substring(0, 16))).toLocaleTimeString()}
                                &nbsp;-&nbsp;
                                {(new Date(taskTimetrack.datetimeStop.date.substring(0, 16))).toLocaleTimeString()}
                            </div>
                        </div>
