...
const TasksListSettingsForm = ({handleSave, settings, setSettings, taskStatuses}) => {
            ...
            <form onSubmit={handleSubmit}>
                <div className="row">
                    <div className="col-12 col-md-6">
                        <h3 className="mb-3 h4">Zobrazení stavů</h3>
                    ...
                    <div className="col-12 col-md-6">
                        <h3 className="mb-3 h4">Zobrazení úkolů</h3>
...
export default TasksListSettingsForm;