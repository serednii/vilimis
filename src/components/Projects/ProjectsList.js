...
const ProjectsList = ({}) => {
    ...
    return (
        <>
            ...
            <div className="my-3">
                <NavLink to="/projects/new" className="btn btn-primary" type="button">Nový projekt</NavLink>
            </div>
                ...
                <div className="card-body">
                    <div className="table-responsive">
                        <table className="table table-centered table-nowrap mb-0 rounded">
                            ...
                            <tbody>
                            {projects && projects.length && projects.map((project, project_key) => (
                                <tr key={project_key}>
                                    <td><NavLink to={"/projects/edit/"+project.id} className="text-primary fw-bold">{project.id}</NavLink></td>
                                    ...
                                    <td>
                                        <NavLink to={"/projects/edit/"+project.id} className="btn btn-sm btn-primary" type="button">Upravit</NavLink>
                                        <button
